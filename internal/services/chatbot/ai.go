...
func shouldUseChatbotAI(message, intent, step, source string, links []repo.ContentResult, confidence float64) bool {
	...
	switch intent {
	case "similar_content", "contact_support", "general_question", "payment_question", "open_article", "site_usage", "site_services", "about_site", "open_classes", "open_search", "search_content", "find_grade", "find_subject", "find_semester", "country_or_curriculum", "site_error", "profile_problem", "report_content", "download_problem", "download_location", "permission_problem", "file_not_found", "email_verification_problem", "auth_login_problem", "auth_register_problem", "password_reset_problem", "social_login_problem", "request_content", "thanks", "frustration":
		return false
	}
...
func isSensitiveNoAI(intent string) bool {
	switch intent {
	case "similar_content", "unsupported_phone_feature", "account_lookup_privacy", "privacy_request", "contact_support", "general_question", "payment_question", "open_article", "site_usage", "site_services", "about_site", "open_classes", "open_search", "search_content", "find_grade", "find_subject", "find_semester", "country_or_curriculum", "site_error", "profile_problem", "report_content", "download_problem", "download_location", "permission_problem", "file_not_found", "email_verification_problem", "auth_login_problem", "auth_register_problem", "password_reset_problem", "social_login_problem", "request_content", "thanks", "frustration":
		return true
	default:
		return false
	}
